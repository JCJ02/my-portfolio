...
// import { sendEmailSchema } from "@/utilities/zod/EmailSchema";
                        ...
                        <form ref={form} onSubmit={sendEmail} className="bg-[#222831] dark:bg-[#76ABAE] border-[#222831] ] flex flex-col gap-2 p-8 rounded-md w-full">
                            <div className="flex items-center gap-2 w-full">
                                <Input
                                    ...
                                    placeholder="Name"
                                    required={true}
                                    className="bg-white text-xs md:text-md lg:text-lg border-none w-full"
                                    name="sender_name"
                                />
                            ...
                            <Textarea
                                placeholder="Message"
                                required={true}
                                className="bg-white text-xs md:text-md lg:text-lg border-none h-40 w-full"
                                name="message"
                            />
