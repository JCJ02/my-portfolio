                ...
                <div className="flex flex-col lg:flex-row justify-center items-center gap-5 md:gap-10 lg:gap-20 px-5 md:px-16 2xl:px-0 m-auto max-w-[1280px]">
                    <div className="flex flex-col justify-center items-start w-full">
                        ...
                        <p className="font-poppins text-xs md:text-md xl:text-lg text-justify dark:text-[#EEEEEE] py-2 xl:py-5">
                            Hi, I'm John Carlo P. Jacobe, a 22-year-old <b className="text-[#222831] dark:text-[#76ABAE]">Bachelor of Science in Information Technology graduate, Cum Laude,</b> from <b className="text-[#222831] dark:text-[#76ABAE]">Quezon City University</b>. I'm a passionate developer skilled in frontend, backend, and full-stack development.
                        </p>
                        <p className="font-poppins text-xs md:text-md xl:text-lg text-justify dark:text-[#EEEEEE] py-2 xl:py-5">
