                            ...
                            <div className="flex flex-col justify-center items-start gap-2 w-full">
                                <div className="flex flex-col justify-center items-start w-full">
                                    ...
                                    <label className="font-poppins text-xs md:text-md xl:text-lg text-justify dark:text-[#EEEEEE]">
                                        <Link className="text-[#76ABAE] font-bold hover:underline" to={"https://microsource.com.ph/"} target="_blank">MicroSource Inc.</Link> | Quezon City, Philippines | Hybrid
                                    </label>
                                </div>
                        ...
                        <div className="flex justify-center items-start gap-5 w-full">
                            ...
                            <div className="flex flex-col justify-center items-start gap-2 w-full">
                                <div className="flex flex-col justify-center items-start w-full">
                                    ...
                                    <label className="font-poppins text-xs md:text-md xl:text-lg text-justify dark:text-[#EEEEEE]">
                                        <Link className="text-[#76ABAE] font-bold hover:underline" to={"https://lightweightsolutions.co/"} target="_blank">Lightweight Solutions</Link> | Quezon City, Philippines | Hybrid
                                    </label>
                                </div>
                                <div className="flex flex-col justify-center items-start gap-2 pl-5 w-full">
